...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 flex flex-col sm:flex-row h-auto sm:h-16 items-center gap-y-2 gap-x-4 border-b border-gray-200 bg-white px-2 sm:px-4 shadow-sm w-full">
      <div className="flex flex-col sm:flex-1 gap-y-2 gap-x-4 w-full sm:w-auto self-stretch lg:gap-x-6">
        <form className="relative flex flex-1 max-w-full sm:max-w-md" action="#" method="GET">
          ...
          <input
            id="search-field"
            className="block h-full w-full rounded-lg border-0 bg-gray-50 py-2 sm:py-0 pl-10 pr-4 text-gray-900 placeholder:text-gray-400 focus:ring-2 focus:ring-blue-600 focus:bg-white sm:text-sm text-base"
        ...
        <div className="flex items-center gap-x-2 sm:gap-x-4 lg:gap-x-6 w-full sm:w-auto">
          {/* Action Items */}
