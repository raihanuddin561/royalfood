...
function OrderPageContent() {
  ...
  // Filter and sort menu items with advanced filtering options
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 lg:gap-8">
            ...
            <div className="lg:col-span-3 order-1 lg:order-1">
              ...
              <div className="bg-gradient-to-r from-white via-orange-50/50 to-white rounded-xl shadow-lg border border-orange-200 p-4 mb-6">
                ...
                <div className="flex gap-3 items-center mb-4">
                  ...
                  <div className="w-40 sm:w-48">
                    <Select value={mealType} onValueChange={(value) => setMealType(value as 'breakfast' | 'lunch' | 'dinner')}>
                      <SelectTrigger className="h-12 border-2 border-orange-300 rounded-xl bg-gradient-to-r from-white to-orange-50 shadow-sm text-sm font-medium hover:border-orange-400 transition-colors">
                  ...
                  <div className="space-y-4 pt-4 border-t border-gray-200 animate-in slide-in-from-top-2 duration-200">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex border border-gray-300 rounded-lg overflow-hidden">
                          <Button
                            ...
                            className={`rounded-none px-4 h-8 text-xs ${viewMode === 'grid' ? 'bg-orange-500 hover:bg-orange-600 text-white' : 'text-gray-600 hover:bg-gray-50'}`}
                          >
                          ...
                          <Button
                            ...
                            className={`rounded-none px-4 h-8 text-xs ${viewMode === 'list' ? 'bg-orange-500 hover:bg-orange-600 text-white' : 'text-gray-600 hover:bg-gray-50'}`}
                          >
                    ...
                    <div className="pt-2 border-t border-gray-100">
                      <p className="text-sm text-gray-600">
                        ...
                        {(searchTerm || selectedCategory !== 'all' || availabilityFilter !== 'all' || selectedMealTypeFilter !== 'all' || priceRange.min > 0 || priceRange.max < 1000) && (
              ...
              {/* Category Quick Access - Only visible when filters are closed */}
              {!showFilters && (
                <div className="mb-6">
